...
public class MJDumpSymbolTableVisitor extends DumpSymbolTableVisitor {
	...
	Stack<Struct> classType=new Stack<Struct>();
	...
	public void visitStructNode(Struct structToVisit) {
		...
		case Struct.Class:
			output.append("Class [");
			classType.push(structToVisit);
			for (Obj obj : structToVisit.getMembers()) {
				if(obj.getType()==structToVisit)
					output.append("Same-Class ");
				else obj.accept(this);
			}
			classType.pop();
			output.append("]");
			break;
	...
	public void visitObjNode(Obj objToVisit) {
		...
		for (Obj o : objToVisit.getLocalSymbols()) {
			...
			if(!classType.empty() && classType.peek()==o.getType()  && !"this".equals(o.getName())) {
				output.append("Same-Class ");
			}
			else o.accept(this);
			output.append("\n");
